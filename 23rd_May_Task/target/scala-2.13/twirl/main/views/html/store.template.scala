...
"""),_display_(/*3.2*/main("Store Page")/*3.20*/ {_display_(Seq[Any](format.raw/*3.22*/("""
    """),format.raw/*4.5*/("""<h1>Store Page</h1>
""")))}))
      }
    }
  }
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/views/store.scala.html
                  HASH: e1cda4ca95ac5487b4249deb78d46f54a664b32c
                  MATRIX: 722->1|818->4|845->6|871->24|910->26|941->31
